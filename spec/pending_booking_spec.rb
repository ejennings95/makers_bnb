...
describe PendingBooking do
  ...
  let(:property) { double(Properties.add(name: 'Jakes treehouse', description: '4 bedroom house', price: 90, location: '19 Nightingale rd, London, Greater London, UB7 9AQ, England', property_owner_id: property_owner.id), id: Properties.list.first.id)}
